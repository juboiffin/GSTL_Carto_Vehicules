...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [477081.713015, 6114234.650522, 901839.026401, 6394890.709536], maxZoom: 22, minZoom: 1
    })
});
...
map.getView().fit([477081.713015, 6114234.650522, 901839.026401, 6394890.709536], map.getSize());
